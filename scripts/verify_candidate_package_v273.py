"""Package and CPU-check frozen V273; deliberately not a release or score claim."""
...
from run_frozen_confirmation_v273 import PLAN as PLAN_PATH
...
DIRECTORY = ROOT / "artifacts/pure_neural_v273/eight/steps144000"
ARCHIVE = ROOT / "artifacts/pure_neural_v273/candidate_package/v273_shared_budget_candidate_not_released.zip"
OUTPUT = ROOT / "benchmarks/v273_candidate_package_verification.json"
...
def main():
    ...
    sources = fingerprints([ROOT / name for name in (
        "scripts/verify_candidate_package_v273.py", "scripts/build_submission.py",
        "scripts/probe_pure_neural_shared_v257.py", "scripts/evaluate_submission.py",
        "scripts/train_pure_neural_snr_experts.py", "benchmarks/v273_confirmation_plan.json")])
