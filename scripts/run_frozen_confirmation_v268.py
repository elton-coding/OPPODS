...
ROOT = source.ROOT
SEEDS = [62701, 62702, 62703]
OFFSET = 8000
LABELS = ['v257_confirm_v268', 'v268_confirm']
DIRS = [ROOT / source.CONTROL_DIR, source.OUTPUT]
PLAN = ROOT / 'benchmarks/v268_confirmation_plan.json'
RESULT = ROOT / 'benchmarks/v268_confirmation_decision.json'
FAILURE = ROOT / 'benchmarks/v268_confirmation_failure.json'
...
def main():
    ...
    binding += [ROOT / p for p in ('scripts/run_frozen_confirmation_v268.py',
                'tests/test_frozen_confirmation_v268.py', 'docs/experiments/frozen-confirmation-v268.md',
                'benchmarks/v268_confirmation_channel_inventory.json')]
    ...
    try:
        ...
        for i, report in enumerate(reports):
            ...
            source.require_metrics(report, caches[LABELS[i]])
