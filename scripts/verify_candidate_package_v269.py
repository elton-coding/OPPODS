"""Package and CPU-check frozen V269; deliberately not a release or score claim."""
...
from run_frozen_confirmation_v269 import PLAN as PLAN_PATH
...
DIRECTORY = ROOT / "artifacts/pure_neural_v269/eight/lr3e5_steps72000"
ARCHIVE = ROOT / "artifacts/pure_neural_v269/candidate_package/v269_shared_lr_candidate_not_released.zip"
OUTPUT = ROOT / "benchmarks/v269_candidate_package_verification.json"
...
def main():
    ...
    sources = fingerprints([ROOT / name for name in (
        "scripts/verify_candidate_package_v269.py", "scripts/build_submission.py",
        "scripts/probe_pure_neural_shared_v257.py", "scripts/evaluate_submission.py",
        "scripts/train_pure_neural_snr_experts.py", "benchmarks/v269_confirmation_plan.json")])
