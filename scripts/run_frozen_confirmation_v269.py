...
ROOT = source.ROOT
SEEDS = [72701, 72702, 72703]
OFFSET = 8000
LABELS = ['v268_confirm_v269', 'v269_confirm']
DIRS = [ROOT / source.CONTROL_DIR, source.OUTPUT]
PLAN = ROOT / 'benchmarks/v269_confirmation_plan.json'
RESULT = ROOT / 'benchmarks/v269_confirmation_decision.json'
FAILURE = ROOT / 'benchmarks/v269_confirmation_failure.json'
...
def main():
    ...
    binding += [ROOT / p for p in ('scripts/run_frozen_confirmation_v269.py',
                'tests/test_frozen_confirmation_v269.py', 'docs/experiments/frozen-confirmation-v269.md',
                'benchmarks/v269_confirmation_channel_inventory.json')]
