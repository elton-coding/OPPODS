...
def _share_prefix(experts: nn.ModuleList, input_modules: tuple[str, ...],
                  sharing_map: tuple[int, ...] = SHARED_PARENT_MAP) -> None:
    ...
    """
    leaders = {}
    for expert, parent in zip(experts, sharing_map, strict=True):
...
class Transmitter(nn.Module):
    def __init__(self):
        ...
        _share_prefix(self.experts, ("_bit_embed", "_feedback_expand", "_embed"), TX_SHARING_MAP)
