...
- [V257 同父专家共享前八层](experiments/pure-neural-shared-prefix-v257.md)：完整72k本地68.650598，对V250 +0.044570、三组总分均升且配对区间为正，进入[冻结确认](experiments/frozen-confirmation-v257.md)；尚未晋级或达到69，历史信道交叉限制保留。
