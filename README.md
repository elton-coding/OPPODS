...
## 当前通过条件性确认的本地冠军方案（V269）

八组5dB联合最低SNR纯神经专家，512宽10块MLP，共享前8块；冻结Encoder，73,547,840独立参数。V227初始化、全新Adam/72000步，验证选择68000步。相对V268仅恒定学习率2e-5改3e-5；B1152/k8、RMS评分代理+BCE0.05不变。

固定offset2000本地均分 **68.778591**，相对V268 +0.072911，95%[0.022623,0.120945]。冻结offset8000新噪声确认均分 **68.642200**，同窗口相对V268 +0.094469，95%[0.053216,0.146293]，各三组综合分均正。不同窗口绝对分数不能直接比较。

约273MB提交包，完整CPU/实际ZIP接口校验通过。确认2000/2000信道历史复用、祖先谱系有缺口，不是盲测；未达69、线上未知。唯一用户确认线上成绩仍为V223的67.01164987745。

见[提交说明](docs/submission/V269_提交说明.md)、[确认结果](docs/experiments/frozen-confirmation-v269-results.md)、[配置](configs/final.yaml)、[冠军记录](benchmarks/leaderboard.json)。V268及更早不可变包保留。
