...
冻结版严格本地官方同口径评测（2000 样本、4000 UE 分数、seed 1176）：效率 `68.278331`，公平 P10 `50.694444`，总分 **`63.003165`**。三个固定 seed 的平均总分为 **`63.142882`**，相对 V126 提升 `0.000020`；冻结后 seed2029 盲测提升 `0.000365`，P10 不变。以上均为本地验证结果，不等同于线上排行榜成绩。
