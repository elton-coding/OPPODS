...
## 当前通过条件性确认的本地冠军方案（V268）

纯神经八组5dB联合最低SNR专家，宽512/10块MLP；同一父组共享前8块，后2块及输出保持独立。Encoder冻结，73,547,840个独立参数。从V227初始化、全新Adam训练72000步，验证选择69000步。相对V257仅恒定学习率1e-5改为2e-5；B1152/k8、96复反馈、5控制位及RMS软评分损失加0.05原始BCE不变。

固定offset2000三次本地均分 **68.705679**，相对V257 +0.055081，95%区间[0.035367,0.095247]。冻结offset8000新噪声确认均分 **68.480145**，同窗口相对V257 +0.054124，区间[0.022174,0.094702]，三次总分均提高。不同窗口绝对分数不可直接比较。

约273MB包低于1GB。确认窗口2000/2000信道历史复用且祖先谱系有缺口，不能称盲测；未达69、线上未知。唯一用户确认的线上成绩仍为V223的67.01164987745。

见[提交说明](docs/submission/V268_提交说明.md)、[确认记录](docs/experiments/frozen-confirmation-v268-results.md)、[配置](configs/final.yaml)及[冠军记录](benchmarks/leaderboard.json)。V257及更早固定包、原始权重和标签保留。
